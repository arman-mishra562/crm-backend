...
router.delete('/delete-account', auth_middleware_1.isAuthenticated, (0, validateRequest_1.default)({ body: auth_schema_1.deleteAccountSchema }), auth_controller_1.deleteUser);
