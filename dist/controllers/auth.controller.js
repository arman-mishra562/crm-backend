...
exports.deleteUser = exports.logout = exports.resetPassword = exports.forgotPassword = exports.login = exports.resendVerification = exports.verifyEmail = exports.register = void 0;
...
const forgotPassword = async (req, res, next) => {
    try {
        ...
        await mailer_1.default.sendMail({
            ...
            html: (0, emailTemplates_1.generateResetEmail)(link),
        });
        res.json({
            message: "If that email is registered, you'll receive a reset link.",
        });
